...
<div class="grid grid-cols-4">
  <div class="card"><h3>Elezioni</h3><span class="big">${data.kpi.tot_anni}</span>
</div>
  <div class="card"><h3>Periodo</h3><span class="big">${data.kpi.first}–${data.kpi.last}</span>
</div>
  <div class="card"><h3>Affluenza ${data.kpi.first}</h3><span class="big">${data.kpi.affluenza_first}%</span>
</div>
  <div class="card"><h3>Affluenza ${data.kpi.last}</h3><span class="big">${data.kpi.affluenza_last}%</span>
</div>
</div>
