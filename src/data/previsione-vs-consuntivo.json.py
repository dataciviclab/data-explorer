...
Nota: bdap_spese_stato ha un UNICO file multi-anno (2025 contiene 2008-2025).
...
from _util import _parquet_refs, _parquet_exists, get_location
from lab_connectors.duckdb import safe_connect

# bdap_spese_stato: unico file multi-anno (contiene tutti gli anni dal 2008)
SPESE_YEARS = [2025]
# bdap_pagamenti_stato: file per-anno, overlap 2014-2025
spese_loc = get_location("bdap_spese_stato")
pag_loc = get_location("bdap_pagamenti_stato")
PAGAMENTI_YEARS = [y for y in range(2014, 2026) if _parquet_exists("bdap_pagamenti_stato", y, pag_loc)]
...
spese_refs = _parquet_refs("bdap_spese_stato", SPESE_YEARS, spese_loc)
pagamenti_refs = _parquet_refs("bdap_pagamenti_stato", PAGAMENTI_YEARS, pag_loc)
